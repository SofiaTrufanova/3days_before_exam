...
class GameWindow:
    ...
    def final(self, event):
        ...
        self.label_text.configure(text=text.key_situations[-1])
        ...
        if globals.Global.click_index == 19:
            ...
            self.label_text.configure(text=text.result_text[final_result - 2])
    ...
    def next_click(self, event):
        ...
        self.window.bind("<Button-1>", self.do_nothing)
        self.main_text.configure(text=text.main_text[globals.Global.click_index])
        globals.Global.click_index += 1
        if globals.Global.click_index >= 16:
            self.first_study_button.grid_remove()
            self.second_study_button.grid_remove()
            ...
            if globals.Global.is_luck:
                ...
                self.label_text.configure(text=text.key_situations[globals.Global.day])
    ...
    def after_click(self):
        ...
        if globals.Global.is_luck:
            ...
            self.first_lucky_button.configure(text=text.first_lucky_button[globals.Global.lucky_index])
            self.second_lucky_button.configure(text=text.second_lucky_button[globals.Global.lucky_index])
            self.first_lucky_button.grid_remove()
            self.second_lucky_button.grid_remove()
        else:
            globals.Global.study_index += 1
            self.first_study_button.configure(text=text.first_study_button[globals.Global.study_index])
            self.second_study_button.configure(text=text.second_study_button[globals.Global.study_index])
            self.first_study_button.grid_remove()
            self.second_study_button.grid_remove()
        self.window.bind("<Button-1>", self.next_click)
    ...
    def first_study_click(self):
        ...
        if globals.Global.student.work_or_chill_decision('first', globals.Global.study_index) == 1:
            self.main_text.configure(text=text.study_choices[globals.Global.study_index * 2])
        else:
            self.main_text.configure(text=text.study_choices_without_power[globals.Global.no_power])
    ...
    def second_study_click(self):
        ...
        self.main_text.configure(text=text.study_choices[globals.Global.study_index * 2 + 1])
    ...
    def first_lucky_click(self):
        ...
        if globals.Global.student.luck_decision(globals.Global.lucky_index + 1, 'first'):
            self.main_text.configure(text=text.lucky_choices[globals.Global.lucky_index * 2])
        else:
            self.main_text.configure(text=text.lucky_choices[globals.Global.lucky_index * 2 + 1])
